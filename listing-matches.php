...
<br/>
  ...
  <div id="services" >
	...
	$listing_out = "";
			...
			{
				$listing_out.="<div><img style='padding:1px;border:1px solid #032a40; margin: 0 auto;' src='uploads/".$result_set[$i]['listing_id']."/".$result_set[$i]['listing_id']."_1.jpg' alt='".$result_set[$i]['listing_id']."' /></div>";
			}
