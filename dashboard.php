...
$conn=db_connect();
$q="select*from listings where user_id='".$user_id."' AND status='".LISTING_OPEN."' order by listing_id DESC ";
...
<div style="width: 1024px; margin: 0 auto;">
	  ...
	  <div  id="dashtop">
		<div  id="dash">
		  <ul>
			...
			<li><a href="dashboard-sold.php?page=1">Sold</a></li>
	...
	<br/>
		<h3 style="font-size:18pt">&nbsp;&nbsp;Edit Your Open Listings</h3>
		<?php 
